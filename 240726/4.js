...
let result3 = numbers.filter((a) => a>15);
// 출력값 [20, 25]
console.log(result3);
...
console.log(arr.filter((a) => a.length >= 4));
 
 
//5.
var arr = ["banana", "kiwi", "mango", "strawberry", "lime", "orange", "plum", "cherry"];
// 요소의 문자열 길이가 홀수인 요소만 반환하여 출력해주세요
console.log(arr.filter((a) => a.length % 2 !== 0));
...
console.log(arr.map((a) => a.length).filter((b) => b>5).length > 0);
